...
public class ProductServiceRPC extends ProductServiceGrpc.ProductServiceImplBase {
    ...
    @Override
    public void checkProductExists(CheckProductExistsRequest request,
                                   StreamObserver<CheckProductExistsResponse> responseObserver) {
        boolean exists = productRepository.existsByCodigoAndColorAndTalle(
                request.getCodigo(),
                request.getColor(),
                request.getTalle()
        );
