...
public class ClientController {
    ...
    @Operation(summary = "este metodo es para cargar masivamente muchos productos mediante un arhivo csv, en la request el archivo debe ser una cadena en Base64" , description = "devuelve los errores que hubo al crear productos")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista obtenida correctamente"),
            @ApiResponse(responseCode = "500", description = "Error interno del servidor")
    })
    @PostMapping("/addProductsCsv")
    public ProductBulkUploadResponse productBulkUploadResponse (@RequestBody ProductBulkUploadRequest productBulkUploadRequest) {

        ProductBulkUploadResponse productBulkUploadResponse = soapClientService1.productBulkUploadResponse(productBulkUploadRequest);
